clear
echo "\033[34;1m Selamat Datang di Tool Mr.F47UR"
sleep 1
echo "\033[35;1m Anda disini dapat menginstall berbagai tools" | lolcat
sleep 1
echo "\033[31;1m:)  Mohon Hargai Tools Saya (:"
sleep 1
clear
...
apt update && apt upgrade
pkg install irssi
echo "Mohon Hargai Tools Saya, Saya Mengerjakannya 2 hari" | lolcat
fi
...
echo "Tolong Hargai Kerja Keras Saya! Ini Hasil Kerja Saya Selama 2 Hari" | lolcat
fi